#!/usr/bin/env python3
"""
Mock-сервер #1 для тестирования множественных прокси-провайдеров.

Порт: 8001
Модели: llama-3.1-70b, mistral-large
Auth: X-Client-Id: test-token-provider1
"""
...
logging.basicConfig(level=logging.INFO, format='%(asctime)s - [PROVIDER1] - %(levelname)s - %(message)s')
...
EXPECTED_AUTH_VALUE = "test-token-provider1"
